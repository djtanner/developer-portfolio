  ...
  data: [
    {
      ...
      skills: [
        '⚡ Developer for Apple Design Award nominee <a href ="https://www.wavelength.zone/" target="_blank" rel="noopener noreferrer"> Wavelength</a>',
        '⚡ QA Tester for Apple Design Award winner <a href = https://www.rooms.xyz target="_blank" rel="noopener noreferrer">Rooms</a>',
...
export const projects = [
  {
    name: "2D Game Engine",
    desc: "Created a 2D game engine and game using SDL and C++. Implemented Lua scripting with C++ bindings through Sol, and user interface with Dear ImGui. Utilized Entity Component System architecture. Additionally built a tilemap editor tool to use with the engine.",
    github: "https://github.com/djtanner/2dgameengine",
    link: "",
    image: "/img/icons/common/2d.gif",
    descBullets: ["SDL", "C++", "LUA", "SOL", "DEARIMGUI", "GAMEDEV"],
  },
